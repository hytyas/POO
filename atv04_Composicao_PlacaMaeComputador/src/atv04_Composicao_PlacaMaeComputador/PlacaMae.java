...
public class PlacaMae {
    ...
    public PlacaMae(String fabricante, String chipset, int numeroDeSlots, String tipoMemoria) {
    ...
    public void exibirInformacoes(){
        ...
        System.out.println("Tipo de memoria suportada: " + tipoDeMemoriaSuportada);
    }
    public void atualizaChipset(String novoChipset){
        this.chipset = novoChipset;
        System.out.println("Chipset atualizado para:" + novoChipset);
    }
    public void adicionarSlots(){
        this.numeroDeSlots++;
        System.out.println("Slot adicionado. Total atual:" +numeroDeSlots);
    }
    public void definirTipoDeMemoriaSuportada(String tipo){
        this.tipoDeMemoriaSuportada = tipo;
        System.out.println("Tipo de memoria atualizada para:." + tipo);
